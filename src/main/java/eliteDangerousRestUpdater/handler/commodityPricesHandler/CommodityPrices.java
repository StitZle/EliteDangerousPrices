package eliteDangerousRestUpdater.handler.commodityPricesHandler;
	...
	public void insertCommodityPrices()
	{
		...
		try
		{
			...
			for( CSVRecord record : records )
			{
				...
				try
				{
					preparedStatement.setLong( 1, station_ID );
					preparedStatement.setLong( 2, commodityID );
					preparedStatement.setLong( 3, supply );
					preparedStatement.setLong( 4, buyPrice );
					preparedStatement.setLong( 5, sellPrice );
					preparedStatement.setLong( 6, demand );
					preparedStatement.setLong( 7, collectedAt );
